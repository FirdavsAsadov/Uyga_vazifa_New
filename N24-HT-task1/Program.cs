...
var sortedProduct = products.OrderByDescending(a => a.Stars).ThenByDescending(a => a.Inventory).Take(5).ToList();
sortedProduct.ForEach(a => Console.WriteLine(a.Name + "\t" + a.Inventory ));
